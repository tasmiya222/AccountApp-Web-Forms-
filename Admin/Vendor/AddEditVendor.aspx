<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AddEditVendor.aspx.cs" Inherits="AccountApp.Admin.Vendor.AddEditVendor" %>
            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Add</strong> Vendor</h2>
                            </div>
                            <div class="body" style="border: 1px solid">
                                <asp:HiddenField ID="hdn" runat="server" />
                                <div class="row mb-3">
                                    <label for="inputItemName" class="col-sm-2 col-form-label">SaleOrder<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        <asp:TextBox ID="txtcompanyName" runat="server" placeholder="Company Name..." Required CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputItemName" class="col-sm-2 col-form-label">Vendor Code<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        <asp:Label ID="lblVendor" CssClass="form-control" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputItemName" class="col-sm-2 col-form-label">FirstName<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        <asp:TextBox ID="txtFirstName" runat="server" placeholder="Enter Your First Name..." CssClass="form-control" Required></asp:TextBox>

                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputItemName" class="col-sm-2 col-form-label">LastName<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        <asp:TextBox ID="txtLName" runat="server" placeholder="Enter Your Last Name..." CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row mb-3">
