<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseInvoice.aspx.cs" Inherits="AccountApp.Admin.PurchaseOrder.PurchaseInvoice" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <table class="meta">
                <tr>
                    <th><span contenteditable>PO #</span></th>
                    <td><span contenteditable>
                        <asp:Label ID="lblPurchaseID" runat="server" /></span></td>
                </tr>
                <tr>
                    <th><span contenteditable>PO Date  </span></th>
                    <td><span contenteditable>
                        <asp:Label ID="LblPurchaseDate" runat="server" /></span></td>
                </tr>
            ...
            <br />
            <article>
                <asp:Repeater ID="rPurchaseInvoice" runat="server" OnItemDataBound="rPurchaseInvoice_ItemDataBound" >
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td><asp:Label runat="server" ID="lblPrice" Text='<%# Eval("PurchaseCost") %>' /></td>
